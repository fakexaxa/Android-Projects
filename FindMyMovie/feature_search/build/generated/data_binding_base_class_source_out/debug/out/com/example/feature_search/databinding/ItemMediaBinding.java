...
public final class ItemMediaBinding implements ViewBinding {
  ...
  @NonNull
  public final ShapeableImageView ivFavIcon;
  ...
  private ItemMediaBinding(@NonNull ConstraintLayout rootView,
      @NonNull ShapeableImageView ivFavIcon, @NonNull ShapeableImageView ivPoster,
  ...
  public static ItemMediaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.iv_favIcon;
      ShapeableImageView ivFavIcon = ViewBindings.findChildViewById(rootView, id);
      if (ivFavIcon == null) {
        break missingId;
      }
      ...
      return new ItemMediaBinding((ConstraintLayout) rootView, ivFavIcon, ivPoster, tvTitle);
    }
