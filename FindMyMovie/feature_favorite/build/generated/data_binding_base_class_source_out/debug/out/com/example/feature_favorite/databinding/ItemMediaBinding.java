...
public final class ItemMediaBinding implements ViewBinding {
  ...
  @NonNull
  public final ShapeableImageView ivRemoveIcon;

  @NonNull
  public final MaterialTextView tvTitle;

  private ItemMediaBinding(@NonNull ConstraintLayout rootView, @NonNull ShapeableImageView ivPoster,
      @NonNull ShapeableImageView ivRemoveIcon, @NonNull MaterialTextView tvTitle) {
    this.rootView = rootView;
    this.ivPoster = ivPoster;
    this.ivRemoveIcon = ivRemoveIcon;
  ...
  public static ItemMediaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.iv_removeIcon;
      ShapeableImageView ivRemoveIcon = ViewBindings.findChildViewById(rootView, id);
      if (ivRemoveIcon == null) {
        break missingId;
      }
      ...
      return new ItemMediaBinding((ConstraintLayout) rootView, ivPoster, ivRemoveIcon, tvTitle);
    }
