...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  private FragmentFavoriteBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton btnClear, @NonNull MaterialCardView cvQuery,
      @NonNull Guideline glEnd, @NonNull Guideline glStart, @NonNull RecyclerView rvResults) {
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoriteBinding((ConstraintLayout) rootView, btnClear, cvQuery, glEnd,
          glStart, rvResults);
    }
